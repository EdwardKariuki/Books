        ...
        button.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                if (title.isEmpty() && author.isEmpty() && publisher.isEmpty() && isbn.isEmpty()){
                    ...
                    int postion = SpUtil.getPreferenceInt(context, SpUtil.POSITION);
                    if (postion == 0 || postion == 5) {
                        postion = 1;
                    }else{
                        postion++;
                    }
                    String key = SpUtil.QUERY + String.valueOf(postion);
                    String value = title + "," + author + "," + publisher + "," + isbn + ",";
                    SpUtil.setPreferenceString(context, key, value);
                    SpUtil.setPreferenceInt(context, SpUtil.POSITION, postion);
